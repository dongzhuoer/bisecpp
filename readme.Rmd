...
General-purpose optimization using enhanced bisection method. It 
    also contains functions for solving equations and model fitting. Still 
    developing, push request in GitHub is welcomed.

[![Build Status](https://travis-ci.com/dongzhuoer/bisecpp.svg?branch=master)](https://travis-ci.com/dongzhuoer/bisecpp)
[![Build status](https://ci.appveyor.com/api/projects/status/5ko88oq3my482lbt?svg=true)](https://ci.appveyor.com/project/dongzhuoer/bisecpp)
